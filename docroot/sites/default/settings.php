 ...
 * @endcode
 */
$settings['hash_salt'] = '8yad9P8qy87eÂ£^)issi8@54oHrq89e';
...
if (file_exists('/var/www/site-php/d8a1')) {
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_d8a1_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_d8a1_dev_default.inc';
}
// </DDSETTINGS>
