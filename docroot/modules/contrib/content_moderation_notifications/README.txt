...
You may use any valid Twig syntax within the Subject, Adhoc Email addresses, and Message fields.

This will allow you to include additional fields, entity references, conditional logic and twig
functions in these fields.

NOTE: The Twig Tweak module will provide many additional Twig functions to your template, such as drupal_token()
which can be used to display any available tokens.
