...
class LeafletCountryFormatter extends LeafletDefaultFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $map['settings']['minZoom'] = isset($settings["map_position"]["minZoom"]) ? $settings["map_position"]["minZoom"] : NULL;
    $map['settings']['maxZoom'] = isset($settings["map_position"]["maxZoom"]) ? $settings["map_position"]["maxZoom"] : NULL;
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[$delta] = \Drupal::service('leaflet.service')->leafletRenderMap($map, array($feature), $settings['height'] . 'px');
